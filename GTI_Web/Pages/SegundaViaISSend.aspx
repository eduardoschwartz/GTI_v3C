<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/default.Master" AutoEventWireup="true" CodeBehind="SegundaViaISSend.aspx.cs" Inherits="GTI_Web.Pages.SegundaViaISSend" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MenuContentPlaceHolder" runat="server">
    <link href="../css/gti.css" rel="stylesheet" />
        ...
        <div style="color: #3a8dcc;">
            ...
            Emissão de 2ª via do carnê de ISS/Taxa de Licença - 2020<br />
            <br />
            <br />
