<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/default.Master" AutoEventWireup="true" CodeBehind="certidaoisencao.aspx.cs" Inherits="GTI_Web.Pages.certidaoisencao" %>
...
<link href="../css/gti.css" rel="stylesheet" />
    ...
    <script>
        ...
        function formata(campo, mask, evt) {
         ...
         <br />
             <br />
             Certidão de isenção de IPTU<br />
             <br />
             <table style="width: 624px; height: 62px;">
                 <tr>
                     <td class="auto-style1" style="width: 134px">Código do imóvel..:</td>
                     <td>
